...
data ModuleIdentifier = ModuleIdentifier String ModuleType deriving (Data, Show, Eq, Ord)
...
data Module = Module ModuleIdentifier (Maybe FilePath) [ModuleElement] deriving (Data, Show)
